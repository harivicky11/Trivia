...
Trivia is a game where users can test their knowledge answering trivia questions. The functionalities of this apps are:
...
This project uses NPM to manage software dependencies. NPM Relies on the package.json file located in the `frontend` directory of this repository. After cloning, open your terminal and run(same command for windows too):
...
To run the server on linux machine, execute:
...
Harivignesh M build this API (`__init__.py`), test suite (`test_flaskr.py`), and this README.md with some help from mentor and udacity community<br>
